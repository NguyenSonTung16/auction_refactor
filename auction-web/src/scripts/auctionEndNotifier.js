...
/**
 * Helper: Generate Winner Email Template
 */
const getWinnerEmailTemplate = (auction, productUrl) => ({
...
/**
 * Helper: Generate Seller Winner Email Template
 */
const getSellerWinnerEmailTemplate = (auction, productUrl) => ({
...
/**
 * Helper: Generate Seller No Winner Email Template
 */
const getSellerNoWinnerEmailTemplate = (auction) => ({
  to: auction.seller_email,
