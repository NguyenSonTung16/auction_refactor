 ...
 */
function processSingleFile(tempUrl, publicPath, targetPath, type) {
...
function moveUploadedFiles(tempUrls, type) {
  ...
  for (const tempUrl of tempUrls) {
    const resultUrl = processSingleFile(tempUrl, publicPath, targetPath, type);
    if (resultUrl) {
      permanentUrls.push(resultUrl);
    }
  }
